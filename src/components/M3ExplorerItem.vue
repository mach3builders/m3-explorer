...
import M3Collapse from '@mach3builders/m3-collapse'
...
export default {
    ...
    created() {
        this.$root.eventHub.$on('eplorer-item-renamed', this.renamed)
    },

    beforeDestroy() {
        this.$root.eventHub.$off('eplorer-item-renamed', this.renamed)
    },
